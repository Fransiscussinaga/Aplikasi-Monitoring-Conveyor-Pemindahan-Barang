...
$hijau = $db->query("SELECT COUNT(*) AS jumlah FROM lokasi_barang a JOIN barang b JOIN lokasi c ON a.barang_id=b.id AND b.warna=c.warna WHERE b.warna='Hijau' AND a.tanggal = '$tgl'", 0);
$merah = $db->query("SELECT COUNT(*) AS jumlah FROM lokasi_barang a JOIN barang b JOIN lokasi c ON a.barang_id=b.id AND b.warna=c.warna WHERE b.warna='Merah' AND a.tanggal = '$tgl'", 0);
$biru = $db->query("SELECT COUNT(*) AS jumlah FROM lokasi_barang a JOIN barang b JOIN lokasi c ON a.barang_id=b.id AND b.warna=c.warna WHERE b.warna='Biru' AND a.tanggal = '$tgl'", 0);
...
$strhtml .= '<h3 align="center"><b>Laporan Barang Masuk Tanggal '.date("d M Y",strtotime($tgl)).'</b></h3>';
